...
{
	int avail[100],alloc[1000][1000],request[1000],m,n,max[1000][1000],work[100];
	int i,j,need[100][100],finish[100]={0},flag=0,flag1=0,next,count1=0,pid;
	...
	for(j=0;j<m;j++)
	{
		...
		{
			printf("Error max claim exceeded\n");
			return 0;
		}
	...
	for(j=0;j<m;j++)
	{
		...
		alloc[pid][j]=alloc[pid][j] + request[j];
